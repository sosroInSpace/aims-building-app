...
export default function Page_Account() {
    ...
    async function saveAccountDetails() {
        ...
        let newUser: UserModel = new UserModel({
            ...
            CompanyName: !JC_Utils.stringNullOrEmpty(companyName)
                ? companyName
                : undefined,
            ABN: !JC_Utils.stringNullOrEmpty(abn) ? abn : undefined,
            LogoFileId: !JC_Utils.stringNullOrEmpty(logoFileId)
                ? logoFileId
                : undefined,
            Enable2fa: enable2fa,
        });
        ...
        if (enable2fa !== session.data!.user.Enable2fa) {
            await JC_PostRaw("user/toggle2FA", {
    ...
    async function changePassword() {
        ...
        try {
            ...
            setPasswordChangeError(
                error.error || "An error occurred while changing password.",
            );
        }
            ...
            <div className={styles.accountDetailsContainer}>
                <JC_Form
                    ...
                    fields={[
                        ...
                        {
                            ...D_FieldModel_Company(
                                !JC_Utils.stringNullOrEmpty(companyName),
                            ),
                            overrideClass: styles.fieldOverride,
                            value: companyName,
                        ...
                        {
                            ...D_FieldModel_ABN(
                                !JC_Utils.stringNullOrEmpty(abn),
                            ),
                            overrideClass: styles.fieldOverride,
                            value: abn,
                        ...
                        {
                            ...D_FieldModel_Phone(
                                !JC_Utils.stringNullOrEmpty(phone),
                            ),
                            overrideClass: styles.fieldOverride,
                            value: phone,
                                ...
                                <div>
                                    ...
                                    <div style={{ paddingLeft: "11px" }}>
                                        ...
                                        >
                                            ...
                                            enter a code sent to your email each
                                            time you log in.
                                        </div>
                                    </div>
                                </div>
                ...
                <div className={styles.actionButtonsContainer}>
                    ...
                    <JC_Button
                        ...
                        isDisabled={
                            confirmationLoading || saveLoading || logoutLoading
                        }
                    />
