...
export async function GET(request: NextRequest) {
    try {
        ...
        let result = await JC_Utils_Business.sqlGet(O_WeatherModel, code);
...
export async function PUT(request: NextRequest) {
    try {
        ...
        if (isList) {
            ...
            const data: O_WeatherModel = await request.json();
            await O_WeatherBusiness.Create(data);
        }
...
export async function POST(request: NextRequest) {
    try {
        ...
        if (sortOrderOnly) {
            ...
            await O_WeatherBusiness.UpdateSortOrder(code, sortOrder);
        } else {
            const data: O_WeatherModel = await request.json();
            await O_WeatherBusiness.Update(data);
        }
...
export async function DELETE(request: NextRequest) {
    try {
        ...
        await JC_Utils_Business.sqlDelete(O_WeatherModel, code);
