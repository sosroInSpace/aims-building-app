...
export async function GET(request: NextRequest) {
    try {
        ...
        const result = await JC_Utils_Business.sqlGet(O_BuildingTypeModel, code);
...
export async function PUT(request: NextRequest) {
    try {
        ...
        if (isList) {
            ...
            await O_BuildingTypeBusiness.CreateList(dataList);
        } else {
            const data: O_BuildingTypeModel = await request.json();
            await O_BuildingTypeBusiness.Create(data);
        }
...
export async function POST(request: NextRequest) {
    try {
        ...
        if (sortOrderOnly) {
            ...
            const data: O_BuildingTypeModel = await request.json();
            await O_BuildingTypeBusiness.Update(data);
        }
...
export async function DELETE(request: NextRequest) {
    try {
        ...
        await JC_Utils_Business.sqlDelete(O_BuildingTypeModel, code);
        return NextResponse.json({ status: 200 });
    } catch (error) {
        console.log(error);
        return NextResponse.json({ error }, { status: 500 });
