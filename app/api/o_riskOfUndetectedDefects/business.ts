...
export class O_RiskOfUndetectedDefectsBusiness {
    ...
    static async Create(data: O_RiskOfUndetectedDefectsModel) {
        await sql`
            INSERT INTO public."O_RiskOfUndetectedDefects"
    ...
    static async Update(data: O_RiskOfUndetectedDefectsModel) {
        await sql`
            UPDATE public."O_RiskOfUndetectedDefects"
            SET "Name" = ${data.Name},
    ...
    static async Delete(code: string) {
        await JC_Utils_Business.sqlDelete(O_RiskOfUndetectedDefectsModel, code);
    }
