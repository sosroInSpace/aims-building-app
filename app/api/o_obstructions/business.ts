...
export class O_ObstructionsBusiness {
    ...
    static async Create(data: O_ObstructionsModel) {
        await sql`
            INSERT INTO public."O_Obstructions"
    ...
    static async Delete(code: string) {
        await JC_Utils_Business.sqlDelete(O_ObstructionsModel, code);
    }
