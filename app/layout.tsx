...
const kaushanScript = Special_Elite({
    weight: "400",
    subsets: ["latin"],
    variable: "--font-kaushan-script",
});
const shadowsIntoLight = Margarine({
    weight: "400",
    subsets: ["latin"],
    variable: "--title-font",
});
...
export default async function Layout_Root({
    ...
    const isAllowedPageWithoutAuth = allowedPagesWithoutAuth.some(
        (allowedPath) =>
    ...
    return (
        <html lang="en">
            ...
            <body
                className={`${styles.rootMainContainer} ${openSans.variable} ${kaushanScript.variable} ${shadowsIntoLight.variable}`}
                id="rootMainContainer"
            >
                <LoadingProvider>
