...
export class O_BuildingTypeModel extends _Base implements _ModelRequirements {
    static tableName: string = "O_BuildingType";
    ...
    static async Get(code: string) {
        return await JC_Get<O_BuildingTypeModel>(O_BuildingTypeModel, this.apiRoute, { code });
    }
    ...
    static async GetList(paging?: JC_ListPagingModel, abortSignal?: AbortSignal) {
        if (typeof window !== "undefined") {
            return await JC_GetList<O_BuildingTypeModel>(O_BuildingTypeModel, `${this.apiRoute}/getList`, paging, {}, abortSignal);
        } else {
            return await JC_Utils_Business.sqlGetList(O_BuildingTypeModel, "");
        }
    }
    static async Create(data: O_BuildingTypeModel) {
        return await JC_Put<O_BuildingTypeModel>(O_BuildingTypeModel, this.apiRoute, data);
    }
    static async CreateList(dataList: O_BuildingTypeModel[]) {
        return await JC_PutRaw<O_BuildingTypeModel[]>(`${this.apiRoute}/createList`, dataList, undefined, "O_BuildingType");
    }
    static async Update(data: O_BuildingTypeModel) {
        return await JC_Post<O_BuildingTypeModel>(O_BuildingTypeModel, this.apiRoute, data);
    }
    static async UpdateList(dataList: O_BuildingTypeModel[]) {
        return await JC_PostRaw<O_BuildingTypeModel[]>(`${this.apiRoute}/updateList`, dataList, undefined, "O_BuildingType");
    }
    static async Delete(code: string) {
        return await JC_Delete(O_BuildingTypeModel, this.apiRoute, code);
    }
    static async DeleteList(codes: string[]) {
        return await JC_PostRaw(`${this.apiRoute}/deleteList`, { codes }, undefined, "O_BuildingType");
    }
    ...
    static getKeys() {
        return Object.keys(new O_BuildingTypeModel());
    }

    static jcFieldTypeforField(fieldName: keyof O_BuildingTypeModel) {
        switch (fieldName) {
            case "Code":
