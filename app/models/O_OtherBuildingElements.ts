...
export class O_OtherBuildingElementsModel extends _Base implements _ModelRequirements {
    static tableName: string = "O_OtherBuildingElements";
    static apiRoute: string = "o_otherBuildingElements";
    ...
    static async Get(code: string) {
        return await JC_Get<O_OtherBuildingElementsModel>(O_OtherBuildingElementsModel, this.apiRoute, { code });
    }
    ...
    static async GetList(paging?: JC_ListPagingModel, abortSignal?: AbortSignal) {
        if (typeof window !== "undefined") {
            return await JC_GetList<O_OtherBuildingElementsModel>(O_OtherBuildingElementsModel, `${this.apiRoute}/getList`, paging, {}, abortSignal);
        } else {
            return await JC_Utils_Business.sqlGetList(O_OtherBuildingElementsModel, "");
        }
    }
    static async Create(data: O_OtherBuildingElementsModel) {
        return await JC_Put<O_OtherBuildingElementsModel>(O_OtherBuildingElementsModel, this.apiRoute, data);
    }
    static async CreateList(dataList: O_OtherBuildingElementsModel[]) {
        return await JC_PutRaw<O_OtherBuildingElementsModel[]>(`${this.apiRoute}/createList`, dataList, undefined, "O_OtherBuildingElements");
    }
    static async Update(data: O_OtherBuildingElementsModel) {
        return await JC_Post<O_OtherBuildingElementsModel>(O_OtherBuildingElementsModel, this.apiRoute, data);
    }
    static async UpdateList(dataList: O_OtherBuildingElementsModel[]) {
        return await JC_PostRaw<O_OtherBuildingElementsModel[]>(`${this.apiRoute}/updateList`, dataList, undefined, "O_OtherBuildingElements");
    }
    static async Delete(code: string) {
        return await JC_Delete(O_OtherBuildingElementsModel, this.apiRoute, code);
    }
    static async DeleteList(codes: string[]) {
        return await JC_PostRaw(`${this.apiRoute}/deleteList`, { codes }, undefined, "O_OtherBuildingElements");
    }
    ...
    constructor(init?: Partial<O_OtherBuildingElementsModel>) {
        super(init);
        this.Code = "";
        this.Name = "";
        this.SortOrder = 999;
    ...
    static getKeys() {
        return Object.keys(new O_OtherBuildingElementsModel());
    }

    static jcFieldTypeforField(fieldName: keyof O_OtherBuildingElementsModel) {
        switch (fieldName) {
            case "Code":
