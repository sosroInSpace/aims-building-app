...
export class O_FurnishedModel extends _Base implements _ModelRequirements {
    static tableName: string = "O_Furnished";
    static apiRoute: string = "o_furnished";
    ...
    static async Get(code: string) {
        return await JC_Get<O_FurnishedModel>(O_FurnishedModel, this.apiRoute, { code });
    }
    ...
    static async GetList(paging?: JC_ListPagingModel, abortSignal?: AbortSignal) {
        if (typeof window !== "undefined") {
            return await JC_GetList<O_FurnishedModel>(O_FurnishedModel, `${this.apiRoute}/getList`, paging, {}, abortSignal);
        } else {
            return await JC_Utils_Business.sqlGetList(O_FurnishedModel, "");
        }
    }
    static async Create(data: O_FurnishedModel) {
        return await JC_Put<O_FurnishedModel>(O_FurnishedModel, this.apiRoute, data);
    }
    static async CreateList(dataList: O_FurnishedModel[]) {
        return await JC_PutRaw<O_FurnishedModel[]>(`${this.apiRoute}/createList`, dataList, undefined, "O_Furnished");
    }
    static async Update(data: O_FurnishedModel) {
        return await JC_Post<O_FurnishedModel>(O_FurnishedModel, this.apiRoute, data);
    }
    static async UpdateList(dataList: O_FurnishedModel[]) {
        return await JC_PostRaw<O_FurnishedModel[]>(`${this.apiRoute}/updateList`, dataList, undefined, "O_Furnished");
    }
    static async Delete(code: string) {
        return await JC_Delete(O_FurnishedModel, this.apiRoute, code);
    }
    static async DeleteList(codes: string[]) {
        return await JC_PostRaw(`${this.apiRoute}/deleteList`, { codes }, undefined, "O_Furnished");
    }
    ...
    static jcFieldTypeforField(fieldName: keyof O_FurnishedModel) {
        switch (fieldName) {
            case "Code":
